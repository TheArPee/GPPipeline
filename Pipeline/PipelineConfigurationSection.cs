...
namespace GPPipeline
{
    ...
    internal class PipelineConfigurationSection : ConfigurationSection 
    {
        /// <summary>
    ...
    /// </summary>
    internal class PipelineHandlerTypeCollection : ConfigurationElementCollection
    {
        /// <summary>
        ...
        public new PipelineHandlerConfigurationElement this[string stepType] => (PipelineHandlerConfigurationElement)BaseGet(stepType);
    ...
    /// </summary>
    internal class PipelineHandlerConfigurationElement : ConfigurationElement
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates an instance of the class specifying the type name.
        /// </summary>
